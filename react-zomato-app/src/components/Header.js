    ...
    <>
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h1 className="modal-title fs-5 text-danger">Login</h1>
              <button
                type="button"
                className="btn-close"
            ...
            <div className="p-2 ps-3 d-flex justify-content-between align-items-start">
              ...
              <button className="btn bg-danger text-white" onClick={userLogin}>
                Login
              </button>
            </div>
          </div>
      ...
      >
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h1 className="modal-title fs-5 text-danger" id="modalCreateAccountLabel">
                Registration
              </h1>
              <button
                type="button"
            ...
            <div className="p-2 ps-3 d-flex justify-content-between align-items-start">
              ...
              <button className="btn btn-danger border-1" onClick={saveUser}>
                Sign Up
              </button>
            </div>
          </div>
